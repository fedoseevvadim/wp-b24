...
class WPForm
{
	...
	private static $arrForm = [
		...
		[ "Client ID", "client_id", "text" . self::PREFIX, "Client ID" ],
		...
		[ "Связь по полям", "field_link", "textarea" . self::PREFIX, "поле битрикс []->[] " ],
		...
		[ "Поля при создании контакта", "contact_create" . self::PREFIX, "textarea", "Связь по полям у контакта [ID B24]->[Значение]" ],
