...
class WPForm
{
	...
	private static $arrForm = [
		...
		[ "Укажите ID пользователя", "user_id", "text", "от имени которого создавать сущности в Б24" ],
		[ "Укажите 1 если нужно передавать пользователей в Б24 при регистрации", "reg_user", "text", "регистрировать пользователя" ]
	];
